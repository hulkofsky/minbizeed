<?php
function minbizeed_display_my_account_paid_and_shipped_itms_fncs() {
    ...
    <div id="content">
        ...
        <div class="my_box3">
            <div class="padd10">
                ...
                <div class="box_title"><?php _e("Paid and Not Shipped Items", 'minbizeed');?></div>
    ...
    if(have_posts()) :
        while(have_posts()) : the_post();
            minbizeed_get_post_my_account_paid();
        endwhile;
