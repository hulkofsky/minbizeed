...
<html lang="en-US">
	...
	<body>
		<div>
			...
			<h5><a target="_blank" rel="noopener noreferrer" href="http://perishablepress.com/blackhole-bad-bots/" title="Blackhole WordPress Plugin">Blackhole for Bad Bots</a></h5>
		</div>
	</body>
</html><?php 
