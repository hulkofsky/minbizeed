...
function minbizeed_save_custom_fields($pid)
{
    ...
    if (isset($_POST['fromadmin'])) {
        ...
        update_post_meta($pid, "retail_price", minbizeed_clear_sums_of_cash($_POST['retail_price']));
...
//    add_meta_box('penny_bids', 'Auction Bids', 'minbizeed_theme_penny_bids', 'auction', 'advanced', 'high');
    ...
    add_meta_box('auction_dets', 'Auction Details', 'minbizeed_theme_auction_dts', 'auction', 'side', 'high');
}
...
function minbizeed_theme_auction_dts()
{
    ...
    $r_price = get_post_meta($pid, 'retail_price', true);
    ...
    <div id="post-new4">
        ...
        <div class="form-group">
            ...
            <input id="retail_price" required="required" name="retail_price" size="10" class="form-control do_input"
                   type="text"
                   value="<?php echo $r_price; ?>"/>
            <p class="info">
                This is the market price of the item
            </p>
        </div>
            ...
            <div class="admin_stats">
                ...
                <div class="panel-body">
                    <div class="calculator">
                        <p>
                            <label>Retail Price: </label>
                            <input name="retail_price_cal" type="number"/>
                        </p>
                        <p>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery(".min_price_popup #calc").click(function (e) {
                    e.preventDefault();
                    var retail_price = jQuery('.min_price_popup input[name="retail_price_cal"]').val();
                    if (retail_price > 0) {
                ...
                jQuery(".min_price_popup #reset").click(function (e) {
                    e.preventDefault();
                    jQuery('.min_price_popup input[name="retail_price_cal"]').val("");
