...
function minbizeed_admin_main_menu_scr() {
	...
	add_submenu_page( null, __( 'Users Stats', 'minbizeed' ), __( 'User Stats', 'minbizeed' ), '10', 'user_stats', 'minbizeed_user_bids' );
	...
	add_submenu_page( "dashboard_settings", __( 'Payments Stats', 'minbizeed' ), __( 'Payments Stats', 'minbizeed' ), $capability, 'payments-stats', 'minbizeed_payments_stats' );

	add_submenu_page( "dashboard_settings", __( 'Bids Stats', 'minbizeed' ), __( 'Bids Stats', 'minbizeed' ), $capability, 'bids-stats', 'minbizeed_bids_stats' );

	add_submenu_page( "dashboard_settings", __( 'Free Bids Stats', 'minbizeed' ), __( 'Free Bids Stats', 'minbizeed' ), $capability, 'free-bids-stats', 'minbizeed_free_bids_stats' );

	add_submenu_page( "dashboard_settings", __( 'Real-time notifications', 'minbizeed' ), __( 'Real-time notifications', 'minbizeed' ), $capability, 'realtime-notifications', 'minbizeed_realtime_notifications' );
}