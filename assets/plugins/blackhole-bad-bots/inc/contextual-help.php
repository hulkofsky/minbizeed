	...
	$screen->add_help_tab(
		...
		array(
			...
			'content' => 
				...
				'<ul>'. 
					'<li><a target="_blank" rel="noopener noreferrer" href="http://www.robotstxt.org/">'. esc_html__('Learn more about robots.txt', 'blackhole-bad-bots') .'</a></li>'. 
