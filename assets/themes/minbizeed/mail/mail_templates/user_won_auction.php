        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    ...
                    <p>
                        Click <a href="http://test.dev.minbizeed.com/?msg=login&redirect_url=/my-account/trophy-room/">here</a> to buy it!
                    </p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | You have won your ' . $auction_name . '!',
    ...
    color:#37607D;
        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    <p style="font-weight: lighter;font-size:20px;">
                        User <b style="color:#EFA007;">' . $user_username . '</b> won auction <b style="color:#EFA007;">' . $auction_name . '</b> on Min Bi Zeed
                    </p>
                    <p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | User ' . $user_username . ' won the ' . $auction_name . '!',
        'from_email' => 'info@test.dev.minbizeed.com',
        'from_name' => 'minbizeed',
        'to' => array(
            array(
