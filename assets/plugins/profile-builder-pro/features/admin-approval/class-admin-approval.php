...
class wpp_list_approved_unapproved_users extends PB_WP_List_Table {
    ...
    function prepare_items() {
        ...
        foreach( $queried_users as $user ){
            ...
            $tempArray = array('ID' => $user->ID, 'username' => $user->data->user_login, 'first_name' => trim( $first_name ), 'last_name' => trim( $last_name ), 'email' => $user->data->user_email, 'role'	=> $user_role, 'registered'  => $user->data->user_registered, 'user_status' => $status);
