 ...
 *
 * Template Name: MBZ order return PG
 */
        ...
        <div class="main-container" role="main">
            ...
            switch ($txnResponseCode) {
                case "0" :
                    ...
                    $user_bids_tot = "select * from `mb_272727023023_usermeta` where `meta_key`='user_credits' AND `user_id`=$user_id";
                    ...
                    $bid_package_tot = "select * from `mb_272727023023_penny_packages` where `id`='$bid_package'";
