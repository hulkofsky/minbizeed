        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    ...
                    <p>
                        Click <a href="http://test.dev.minbizeed.com/?msg=login&redirect_url=/my-account/bids-history/">here</a> to check your balance, or <a href="http://test.dev.minbizeed.com/">here</a> to see the latest auctions!
                    </p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | Bid package purchase',
    ...
    color:#37607D;
        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    <p style="font-weight: lighter;font-size:20px;">
                        User <b style="color:#EFA007;">' . $user_username . '</b> purchased <b style="color:#EFA007;">' . $package_bid . '</b> BIDS on Min Bi Zeed
                    </p>
                    <p>
