                ...
                <div class="panel-body">
                    <div class="calculator">
                        ...
                        <p>
                            ...
                            <input name="constant" type="number" value="0.41" placeholder="default: 0.41"/>
                        </p>
                        <p class="min_price">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery(".min_price_popup #calc").click(function (e) {
                    ...
                    var constant = jQuery('input[name="constant"]').val();
                    if (retail_price > 0) {

                        var set_constant = 0.41;
                        if (constant) {
                            set_constant = constant;
                        }

                        var clicks = retail_price / set_constant;
