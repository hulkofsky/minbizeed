        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    ...
                    Welcome <b>' . $user_username . '</b> to test.dev.minbizeed.com,<br>
                    <p>
                        You may login to your account using the following info:
                    </p>
                    <p>
                        Login Link: <b><a href="http://test.dev.minbizeed.com/?msg=login">http://test.dev.minbizeed.com/</a></b>
                    </p>
                    <p class="has_link">
    ...
    color:#37607D;
        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    <p style="font-weight: lighter;font-size:20px;">
                        User <b style="color:#EFA007;">' . $user_username . '</b> registered to Min Bi Zeed:
                    </p>
                    <p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | New user registration',
        'from_email' => 'info@test.dev.minbizeed.com',
        'from_name' => 'minbizeed',
        'to' => array(
            array(
