<?php
/*send user email custom auction reminder*/
function tbid_custom_auction_reminder_user($user_id, $auction_id)
{
        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    ...
                    <p style="font-weight: lighter;font-size:20px;">
                        The <b>' . $auction_name . '</b> auction is ending in a few!
                    </p>
                    <p>
                        <b><a href="http://test.dev.minbizeed.com/?msg=login&redirect_url=' . $auction_link . '">START BIDDING NOW!</a></b>
                    </p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | Auction ' . $auction_name . ' is ending!',
