        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:top; padding:30px;font-family:lucida grande,tahoma,verdana,arial,sans-serif">
                    ...
                    <p>
                        Click <b><a href="http://test.dev.minbizeed.com/?msg=login&redirect_url=' . $auction_link . '">here</a></b> to bid on this auction.
                    </p>
...
';
    ...
    $message = array(
        'html' => $html_msg,
        'subject' => 'Min Bi Zeed | Auction ' . $auction_name . ' is ending in 15 mins!',
