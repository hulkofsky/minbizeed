 ...
 *
 * Template Name: MBZ Item order form PG
 */
get_header();
...
// test   $_POST["vpc_AccessCode"] = "8E07362B";
    ...
    $_POST["vpc_ReturnURL"] = "http://test.dev.minbizeed.com/item-order-return/";
    ...
    global $wpdb;
    $s = "select * from `mb_272727023023_migs_transactions_data` where `signature`='$signature' AND `verified`=0";
...
// set a parameter to show the first pair in the URL
        ...
        ?>
        <input type="hidden" name="order_red_1" value="/my-account/trophy-room/?msg=sig_error">
        <script type="text/javascript">
