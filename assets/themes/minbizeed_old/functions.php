...
/*MM login start*/
require_once(TEMPLATEPATH . '/includes/mm-login/mm-login.php');
/*MM login end*/

/*AJAX start*/
require_once(TEMPLATEPATH . '/includes/ajax/update_shpg_info.php');
/*AJAX end*/

/*My account start*/
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/my_account.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/personal_info.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/payments.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/won_items.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/paid_shipped.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/my_bids.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/paid_and_not_shipped.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/unpaid.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/purchase_bids.php');
require_once(TEMPLATEPATH . '/includes/posts_templates/my_account/purchase_items.php');
/*My account end*/
