<?php
/*Check if testing auction start*/
minbizeed_single_auction_testing(get_the_ID());
/*Check if testing auction end*/
get_header();
global $current_user;
get_currentuserinfo();
$uid = $current_user->ID;
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 product_information<?php if (count($res) > 0): echo ' all_green'; endif; ?>">
                        <div class="product_information_wrapper">
                            ...
                            <div class="bidding_info_wrapper">
                                <div class="your_bids">
                                    <span>You have</span>
                                    <span class="bids_ribbon"><b class="landing_balance"><?php echo($user_credits ? $user_credits : "0"); ?></b>Bids<span class="fold"></span></span>
                                </div>
                                ...
                                <div class="bid_cost">
                                    ...
                                    <span class="bids_ribbon"><?php if ($time_increase): echo "x<b class='price_increase'>" . $time_increase . "</b> Bids"; endif; ?>
...
<!--                                     src="--><?php //echo get_template_directory_uri(); ?><!--/images/exclamation.png">-->
                            ...
                            <?php
                                $current_auto_bid = minbizeed_get_current_autobid($pid, $uid);
                                if (is_user_logged_in() && $closed != 1) {
                                    ?>
                                    <div class="autobid_cont" id="<?php echo get_the_ID(); ?>" data-userid="<?php echo $uid; ?>">
                                        <?php
                                        if (isset($current_auto_bid)) {
                                            if ($current_auto_bid['paused']) {
                                                ?>
                                                <h3>Auto Bid (Paused)</h3>
                                                <?php
                                            } else {
                                                ?>
                                                <h3>Auto Bid (Running)</h3>
                                                <?php
                                            }
                                        } else {
                                            ?>
                                            <h3>Auto Bid (Not active)</h3>
                                            <?php
                                        }
                                        ?>
                                        <div class="amount_cont">
                                            <p>
                                                ...
                                                You still have
                                                <span
                                                    class="auto_bid_rem_amount"><?php echo get_user_meta($user_ID, 'user_credits', true) ?></span>
                                                Bids!
                                            </p>
                                            <p class="autobid_info" <?php if (!isset($current_auto_bid['credits_left'])): echo "style='display:none;'"; endif; ?>">
                                                <i class="fa fa-star" aria-hidden="true"></i>
                                                Your remaining autobid amount is:
                                                    <span
                                                        class="auto_bid_max_amount"><?php echo $current_auto_bid['credits_left']; ?></span>
                                                Bids
                                            </p>
                                        </div>
                                        <div class="input_cont">
                                            <label for="autobid_amount">Max bidding amount: </label>
                                            <input type="number" name="autobid_amount"
                                                   placeholder="<?php if (isset($current_auto_bid['credits_left'])):echo $current_auto_bid['credits_left'] . ' Bids';
                                                   else: echo 'Enter amount here';endif; ?>"
                                                   value=""/>
                                            <?php
                                            if (!$current_auto_bid) {
                                                ?>
                                                <a href="#" class="autobid_start" title="start">
                                                    <i class="fa fa-play-circle" aria-hidden="true"></i>
                                                </a>
                                                <?php
                                            } else {
                                                ?>
                                                <a href="#" class="autobid_start" title="Update amount">
                                        ...
                                        <div class="actions_cont">
                                            <a href="#" class="autobid_play"
                                               style="<?php if ((isset($current_auto_bid['paused']) && $current_auto_bid['paused'] == 0) || (!$current_auto_bid)):echo "display:none;";endif; ?>"
                                               title="Auto bid is paused, play?">
                                                <i class="fa fa-play" aria-hidden="true"></i>
                                            </a>
                                            <a href="#" class="autobid_pause"
                                               style="<?php if ((isset($current_auto_bid['paused']) && $current_auto_bid['paused'] == 1) || (!$current_auto_bid)): echo "display:none;";endif; ?>"
                                               title="Auto bid is running, pause?">
